...
window.onload = () => {
    const toast = new bootstrap.Toast(toastElem, { animation: true, autohide: false })
...
const alert = (type = 'done', message = 'This website uses cookies. We use cookies to ensure that we give you the best experience on our website.', autohide = true) => {

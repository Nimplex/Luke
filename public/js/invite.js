...
const open = (id) => {
    const url = `https://discord.com/api/oauth2/authorize?client_id=576478552158109716&permissions=8&guild_id=${id}8&redirect_uri=https%3A%2F%2Flukebot.xyz%2Fapi%2Flogin&response_type=code&scope=bot%20identify%20guilds`
